...
On s'intéresse au nombre d'enfants de moins de 25 ans par couple en France en 2017 [[source](https://www.insee.fr/fr/statistiques/4516614?sommaire=4516657&geo=FE-1)].
...
freq <- ggplot(couples,
  ...
  scale_y_continuous(name = "Fréquence",
                     sec.axis = sec_axis(transform = ~. *  sum(effectifs), name="Effectif")) + 

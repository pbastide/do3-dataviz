---
title: "TP 2 - Introduction à `R markdown` et `ggplot2`"
author: "Paul Bastide"
date: "30/03/2021"
...
On pourra utiliser les fonctions `min`, `which.min`, `which.max` et `as.Date`.
...
Faire varier le type de graphique et leur taille (lignes ou points plus ou poins gros),
...
différentes, au lieu des les réprésenter sur l'axed des y.
...
Faire varier l'attribution des différentes colones de données aux différentes `aes`,
...
nomez les axes de manière informative (avec les unités),
et ajoutez un titre.

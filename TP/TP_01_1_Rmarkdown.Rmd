...
=======
On reproduit cette expérience 100 fois.  
>>>>>>> dcc8e198b4c0d6c82a50a57559b5b0578a0df9cf
...
=======
boules <- c(rep("rouge", 100),         ## 100 boules rouges
            rep("bleue", 100),         ## 100 boules bleues
            rep("verte", 100))         ## 100 boules vertes 

n_exp <- 100                           ## Nombre de fois où je fais l'expérience
>>>>>>> dcc8e198b4c0d6c82a50a57559b5b0578a0df9cf
...
> La variable a-t-elle bien des modalités incompatible, exhaustives et sans ambiguité ? 
=======
> (le Lez est très polué).
> On suppose cependant que l'on n'a pas accès à cette information
> (on ne sait pas combien il y a de poissons en tout, ni combien de chaque couleur).
>
> On se pose la question : "Quelle est la porportion de poissons rouges, verts et bleus dans le Lez ?"
> 
> On pêche $100$ poissons, que l'on garde pour les exposer en aquarium, et l'on note leur couleur.
>
> Décrivez l'expérience statistique : individus, population, échantilon, taille, type variable mesurée.
>>>>>>> dcc8e198b4c0d6c82a50a57559b5b0578a0df9cf
>
...
=======
> Quels résultats obtenez-vous ? L'estimation est-elle bonne dans ce cas ?
>>>>>>> dcc8e198b4c0d6c82a50a57559b5b0578a0df9cf
>

...
**Variable**: âge  
**Modalités**: un chiffre  

**Variable**: somme versée à l'administration  
**Valeurs**: un nombre plus grand ou égal à zéro
...
**Variable**: âge; $\qquad$ **Modalités**: un chiffre  
...
*Les français sont-ils plus vieux que les allemands ?*
...
*sondage auprès de 1000 français et allemands tirés au hasard*
